	...
	control: [
		{
			...
			description: "Подъёмник с кнопочным управлением управляется человеком, сопровождающим инвалида-колясочника."
		},
		{
			id: getNextId(),
			image: Media.PP_110_E_IMG_3.image,
			name: "Дистанционное управление",
			description: "Подъёмник с дистанционным управлением управляется непосредственно самим инвалидом-колясочником."
		}
	],
	connection: [],
	specifications: [
